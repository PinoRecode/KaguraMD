...
// Reply
const reply = (teks) => {
kagura.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": `${botname}`,"body": `Selamat ${salam} kak ${pushname}`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": thumb,"sourceUrl": `${myweb}`}}}, { quoted: m })
}
// Reply 2
const replay = (teks) => {
kagura.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": `${botname}`,"body": `Selamat ${salam} kak ${pushname}`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": thumb,"sourceUrl": `${myweb}`}}}, { quoted: m })
...
if (args[0] === 'mute') {
kagura.chatModify({ mute: 'Infinity' }, m.chat, []).then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
} else if (args[0] === 'unmute') {
kagura.chatModify({ mute: null }, m.chat, []).then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
} else if (args[0] === 'archive') {
kagura.chatModify({archive: true }, m.chat, []).then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
} else if (args[0] === 'unarchive') {
kagura.chatModify({ archive: false }, m.chat, []).then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
} else if (args[0] === 'read') {
kagura.chatModify({ markRead: true }, m.chat, []).then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
} else if (args[0] === 'unread') {
kagura.chatModify({ markRead: false }, m.chat, []).then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
} else if (args[0] === 'delete') {
kagura.chatModify({ clear: { message: { id: m.quoted.id, fromMe: true }} }, m.chat, []).then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
}
}
break
case 'family100': {
...
await kagura.sendButtonText(m.chat, buttons, jawab, ownername, m, {mentions: menst})
}
break
case 'apakah':
...
kagura.sendMessage(from, { text: `Rate : ${q}\nJawaban : *${te}%*` }, { quoted: m })
...
kagura.sendMessage(from, { text: `Nama : ${q}\nJawaban : *${teng}%*` }, { quoted: m })
...
await kagura.groupAcceptInvite(result).then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
}
break
case 'leave': {
if (!isCreator) return reply(mess.owner)
await kagura.groupLeave(m.chat).then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
}
break
case 'setexif': {
 if (!isCreator) return reply(mess.owner)
...
await kagura.groupParticipantsUpdate(m.chat, [users], 'remove').then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
}
break
case 'add': {
if (!m.isGroup) return reply(mess.group)
...
await kagura.groupParticipantsUpdate(m.chat, [users], 'add').then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
}
break
case 'promote': {
if (!m.isGroup) return reply(mess.group)
...
if (!isAdmins) return reply(mess.admin)
let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
await kagura.groupParticipantsUpdate(m.chat, [users], 'promote').then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
}
break
case 'demote': {
if (!m.isGroup) return reply(mess.group)
...
if (!isAdmins) return reply(mess.admin)
let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
await kagura.groupParticipantsUpdate(m.chat, [users], 'demote').then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
}
break
case 'block': {
if (!isCreator) return reply(mess.owner)
let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
await kagura.updateBlockStatus(users, 'block').then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
}
break
case 'unblock': {
if (!isCreator) return reply(mess.owner)
let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
await kagura.updateBlockStatus(users, 'unblock').then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
}
break
...
if (!isAdmins) return reply(mess.admin)
if (!text) throw 'Text ?'
await kagura.groupUpdateSubject(m.chat, text).then((res) => reply(mess.success)).catch((err) => reply(jsonformat(err)))
}
break
...
if (!isAdmins) return reply(mess.admin)
if (!text) throw 'Text ?'
await kagura.groupUpdateDescription(m.chat, text).then((res) => reply(mess.success)).catch((err) => reply(jsonformat(err)))
}
break
case 'setbiobot':{
if (!isCreator) return reply(mess.owner)
...
if (!isAdmins) return reply(mess.admin)
if (args[0] === 'close'){
await kagura.groupSettingUpdate(m.chat, 'announcement').then((res) => reply(`Sukses Menutup Group`)).catch((err) => reply(jsonformat(err)))
} else if (args[0] === 'open'){
await kagura.groupSettingUpdate(m.chat, 'not_announcement').then((res) => reply(`Sukses Membuka Group`)).catch((err) => reply(jsonformat(err)))
} else {
let buttons = [
{ buttonId: 'group open', buttonText: { displayText: 'Open' }, type: 1 },
{ buttonId: 'group close', buttonText: { displayText: 'Close' }, type: 1 }
]
await kagura.sendButtonText(m.chat, buttons, `Mode Group`, ownername, m)
...
if (!isAdmins) return reply(mess.admin)
 if (args[0] === 'open'){
await kagura.groupSettingUpdate(m.chat, 'unlocked').then((res) => reply(`Sukses Membuka Edit Info Group`)).catch((err) => reply(jsonformat(err)))
 } else if (args[0] === 'close'){
await kagura.groupSettingUpdate(m.chat, 'locked').then((res) => reply(`Sukses Menutup Edit Info Group`)).catch((err) => reply(jsonformat(err)))
 } else {
 let buttons = [
{ buttonId: 'editinfo open', buttonText: { displayText: 'Open' }, type: 1 },
{ buttonId: 'editinfo close', buttonText: { displayText: 'Close' }, type: 1 }
]
await kagura.sendButtonText(m.chat, buttons, `Mode Edit Info`, ownername, m)
...
await kagura.sendButtonText(m.chat, buttons, `Mode Antilink`, ownername, m)
}
 }
 break
 case 'mute': {
...
await kagura.sendButtonText(m.chat, buttons, `Mute Bot`, ownername, m)
}
 }
 break
...
if (args[0] === 'enable') {
await kagura.sendMessage(m.chat, { disappearingMessagesInChat: WA_DEFAULT_EPHEMERAL }).then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
} else if (args[0] === 'disable') {
await kagura.sendMessage(m.chat, { disappearingMessagesInChat: false }).then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
}
}
break
...
if (!isCreator) return reply(mess.owner)
if (!q) return reply(`Text mana?\n\nExample : ${prefix + command} Gur ganteng`)
...
kagura.send5ButImg(i, txt, ownername, global.thumb, btn)
}
...
let txt = `「 Broadcast Bot 」\n\n${text}`
kagura.send5ButImg(yoi, txt, ownername, global.thumb, btn)
}
...
reply(mess.wait)
mee = await kagura.downloadAndSaveMediaMessage(quoted)
mem = await TelegraPh(mee)
meme = `https://api.memegen.link/images/custom/-/${text}.png?background=${mem}`
memek = await kagura.sendImageAsSticker(m.chat, meme, m, { packname: global.packname, author: global.author })
...
let Gur = await kagura.sendImageAsSticker(m.chat, smeme, m, { packname: global.packname, author: global.auhor })
await fs.unlinkSync(Gur)
}
 break 
...
let { toAudio } = require('./lib/converter')
let audio = await toAudio(media, 'mp4')
kagura.sendMessage(m.chat, {document: audio, mimetype: 'audio/mpeg', fileName: `Convert By ${ownername}.mp3`}, { quoted : m })
}
break
...
kagura.Webtoons(q).then(async data => {
...
if (!text) return reply('Yang mau di cari apa?')
await reply(mess.wait)
kagura.Drakor(`${text}`).then(async data => {
...
if (!text) return reply('Yang mau di cari apa?')
await reply(mess.wait)
kagura.Anime(q).then(async data => {
...
await kagura.send5ButLoc(from, txt , `© ${ownername}`,gam, but , { userJid: m.chat, quoted: m })
})
.catch((err) => {
reply(mess.error)
})
...
if (!text) return reply('Yang mau di cari apa?')
await reply(mess.wait)
kagura.Character(q).then(async data => {
...
if (!text) return reply('Yang mau di cari apa?')
await reply(mess.wait)
kagura.Manga(`${text}`).then(async data => {
...
await kagura.send5ButImg(from, `⭔ _*Title :*_ ${cerpe.title}\n⭔ _*Author :*_ ${cerpe.author}\n⭔ _*Category :*_ ${cerpe.kategori}\n⭔ _*Pass Moderation :*_ ${cerpe.lolos}\n⭔ _*Story :*_\n${cerpe.cerita}`, `© ${ownername}`,riych, [{"urlButton": {"displayText": "YouTube Creator","url": `${youtube}`}}] )
}
break
case 'fajar-news':
reply(mess.wait)
...
teks = "*Darkjokes*"
kagura.sendMessage(m.chat, { image : { url : res }, caption: teks }, { quoted : m })
break
case 'cnn-news':
CNNNews().then(res => {
no = 0
...
teks += ""
kagura.sendMessage(m.chat, { image : { url : res[0].berita_thumb }, caption: teks }, { quoted : m })
})
break
case 'tribun-news':
reply(mess.wait)
...
for (let media of anu.data) kagura.sendMedia(m.chat, media, '', `Download Url Instagram From ${isUrl(text)[0]}`, m)
} else if (/\/stories\/([^\s&]+)/.test(isUrl(text)[0])) {
let anu = await fetchJson(api('zenz', '/downloader/instastory', { url: isUrl(text)[0] }, 'apikey'))
kagura.sendMedia(m.chat, anu.media[0].url, '', `Download Url Instagram From ${isUrl(text)[0]}`, m)
}
}
break
...
kagura.sendMessage(m.chat, { video: { url: anu.data[0] } }, { quoted: m })
}
break
...
kagura.sendMessage(m.chat, {document: yy, mimetype: 'application/pdf', fileName: `iqra${text}.pdf`}, {quoted:m}).catch ((err) => reply(oh))
}
break
case 'juzamma': {
if (args[0] === 'pdf') {
...
await kagura.sendButtonText(m.chat, buttons, `\`\`\`Kamu Masih Berada Di dalam Sesi Anonymous, Tekan Button Dibawah Ini Untuk Menghentikan Sesi Anonymous Anda\`\`\``, ownername, m)
throw false
}
...
await kagura.sendButtonText(room.a, buttons, `\`\`\`Berhasil Menemukan Partner, sekarang kamu dapat mengirim pesan\`\`\``, ownername, m)
room.b = m.sender
room.state = 'CHATTING'
await kagura.sendButtonText(room.b, buttons, `\`\`\`Berhasil Menemukan Partner, sekarang kamu dapat mengirim pesan\`\`\``, ownername, m)
} else {
let id = + new Date
this.anonymous[id] = {
id,
...
await kagura.sendButtonText(m.chat, buttons, `\`\`\`Mohon Tunggu Sedang Mencari Partner\`\`\``, ownername, m)
}
break
}
...
const sendm = kagura.sendMessage(from, templateMessage)
}
break
case 'speed': {
let timestamp = speed()
...
.then(({data}) => {
kagura.sendImageAsSticker(m.chat, data.url, m, { packname: global.packname, author: global.author })
})
break
...
.then(({data}) => {
kagura.sendImage(m.chat, data.url, mess.success, m)
})
break
case 'playstore': {
...
case "setmenu": 
if (!isCreator) return reply(mess.owner)
if (!text) return reply("1.allmenu\n2.simpel\n\nContoh .setmenu simpel")
// Menu All
if (q == "allmenu") {
typemenu = 'allmenu'
reply("Succes Mengganti Menu "+q)
}
// Menu Simple
else if (q == "simpel") {
typemenu = 'simple'
...
case 'menu1':
case 'groupmenu':
reply(`${(lang.groupmenu(prefix))}`)
break
case 'menu2':
case 'downloadermenu':
reply(`${(lang.downloadermenu(prefix))}`)
break
case 'menu3':
case 'searchmenu':
reply(`${(lang.searchmenu(prefix))}`)
break
case 'menu4':
case 'telestickmenu':
reply(`${(lang.telestickmenu(prefix))}`)
break
break
case 'menu5':
case 'randommenu':
reply(`${(lang.randommenu(prefix))}`)
break
case 'menu6':
case 'randomanimemenu':
reply(`${(lang.randomanimemenu(prefix))}`)
break
case 'menu7':
case 'searchmenu':
reply(`${(lang.searchmenu(prefix))}`)
...
case 'menu8':
case 'textpromenu':
reply(`${(lang.textpromenu(prefix))}`)
break
case 'menu9':
case 'photooxymenu':
reply(`${(lang.photooxymenu(prefix))}`)
break
case 'menu10':
case 'ephotomenu':
reply(`${(lang.ephotomenu(prefix))}`)
break
case 'menu11':
case 'funmenu':
reply(`${(lang.funmenu(prefix))}`)
break
case 'menu12':
case 'primbonmenu':
reply(`${(lang.primbonmenu(prefix))}`)
break
case 'menu13':
case 'cerpenmenu':
reply(`${(lang.cerpenmenu(prefix))}`)
break
case 'menu14':
case 'convertmenu':
reply(`${(lang.convertmenu(prefix))}`)
break
case 'menu15':
case 'informationmenu':
reply(`${(lang.informationmenu(prefix))}`)
break
case 'menu16':
case 'mainmenu':
reply(`${(lang.mainmenu(prefix))}`)
break
case 'menu17':
case 'databasemenu':
reply(`${(lang.groupmenu(prefix))}`)
...
case 'menu18':
case 'anonymousmenu':
reply(`${(lang.anonymousmenu(prefix))}`)
break
case 'menu19':
case 'islamicmenu':
reply(`${(lang.islamicmenu(prefix))}`)
break
case 'menu20':
case 'voicechargermenu':
reply(`${(lang.voicechargermenu(prefix))}`)
break
case 'menu21':
case 'ownermenu':
reply(`${(lang.ownermenu(prefix))}`)
break
case 'donasi': case 'donate':
reply(`${(lang.donasi(ownernomer))}`)
break
